 ...
 */
final class Version20250402072645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location ADD region VARCHAR(255) NOT NULL, ADD country VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location DROP region, DROP country');
